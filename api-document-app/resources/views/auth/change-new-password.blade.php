        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="col d-flex flex-column align-items-center">
                    <form action="{{ route('login') }}" method="POST" class="body d-flex flex-column justify-center align-items-center needs-validation" style="width: auto; margin-top: 20%;" novalidate>
                        @csrf
